...
Keys are cited as `[Sxx]` throughout `findings/`, `model/site_model.py`, the critique log and the course design.
...
| S06 | Australian Government, *Your Home*, Rainwater. https://www.yourhome.gov.au/water/rainwater (the 150 L/person/day rainwater-only figure came via a summary citing Your Home) | 1 mm on 1 m² = 1 L; first-flush sizing ~10 L per 50 m²; tank-size table; **150 L/person/day** for rainwater-only households | primary (page) / summary (150 L figure) | medium: find the 150 L/p/d figure on a Your Home page before publishing it |
...
| S08 | enHealth (2010) *Guidance on use of rainwater tanks*, 3rd ed., Appendix B. https://www.cdc.gov.au/system/files/2025-10/enhealth-guidance-the-use-of-rainwater-tanks.pdf | Runoff = A × (rainfall − B) × roof area, A = 0.80–0.85, B = 2 mm/month (Martin 1980); monthly balance V_t = V_(t−1) + runoff − demand; 90 %/99 % security tables; UV lamps replaced every 9–12 months; boiling or disinfection when in doubt | primary | high |
...
| S10 | NSW Health / NSW Office of Water greywater diversion guidance (fact sheets, *NSW Guidelines for greywater reuse in sewered single household residential premises*) | Untreated greywater: subsurface irrigation ≥10 cm below soil or mulch; no storage; kitchen water excluded unless treated; WaterMark-licensed devices | summary | medium-high |
...
| S35 | Standards Australia AS 4454-2012 *Composts, soil conditioners and mulches* | Pasteurisation: ≥55 °C for 3 consecutive days, repeated across ≥3 turns. Higher-risk feedstocks (manure, food, grease trap): ≥55 °C for ≥15 days with ≥5 turns | summary | medium-high |
...
| S36 | USDA NIFA *Safely fermenting food at home*; NCHFP / Penn State / Clemson extension | Sauerkraut: 2–2.5 % salt by weight; ferment at 21–24 °C for 3–4 weeks; safe when pH ≤4.6; do not reduce salt | summary | medium-high |
