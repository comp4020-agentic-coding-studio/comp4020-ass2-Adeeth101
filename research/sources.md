...
| S12a | Brouwer, C., Prins, K. & Heibloem, M. (1989) *Irrigation Water Management Training Manual 4: Irrigation scheduling*, FAO, Annex I, Table 8. https://www.fao.org/4/t7202e/t7202e08.htm | Indicative field application efficiency: surface 60 %, sprinkler 75 %, drip 90 % (V12) | primary | high for the indicative values |
...
| S14 | Ecology Action (22 October 2018) *"GROW BIOINTENSIVE Closed-Loop" Sustainability Protocol*, 6 pp. https://www.growbiointensive.org/PDF/GBSustainability_Protocol%20_2018.pdf | Two estimates in one document: p.3 footnote 1, "approximately 4,000 square feet of planted surface" (about 372 m²) as the minimum for one person's soil fertility, a well-designed vegan diet **and income**, at **intermediate** yields; p.6, a vegan diet "on as little as 4,000-sq-ft with beginning GB yields" and "2,000-sq-ft with intermediate GB yields" (about 186 m²). Both assume 60 % carbon-and-calorie crops, 30 % root crops, 24-inch double-dug soil and closed-loop compost. Average US omnivore diet: 101,000 ft² (V11). **Replaces** the earlier FAQ summary | primary | high for what the document says; not a threshold for any household |
